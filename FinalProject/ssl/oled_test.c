...
/**************************************************************************/
void displayFonts(int numofSymbols) {
    // Loop through each byte in the font array
    int i;
    for (i = 0; i < numofSymbols; i++) {     // 1275 for all the fonts. This is the test
        // Call drawChar function on each item
        drawChar(0,0,font[i],BLACK,WHITE,15);
        delay(10);
    }
}
